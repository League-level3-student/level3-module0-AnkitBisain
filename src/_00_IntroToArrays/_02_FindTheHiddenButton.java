...
public class _02_FindTheHiddenButton implements ActionListener {
	...
	public void start() {
		...
		String givenString = JOptionPane.showInputDialog(null, "Enter a positive integer.");
		int given = Integer.parseInt(givenString);
		if(given <= 0) {
			System.exit(0);
		}
		// 4. Initialize the array of JButtons to be the size of the int created in step
		// 3
		jbuttons = new JButton[given];
